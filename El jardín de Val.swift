...
let El_jardín_de_Val: TraductedText = TraductedText(
    originalText: Text(lang: Lang.es,
    ...
    voc: [
          OriginalWord(lang: Lang.es , wordInText: "hablo con", neutralWord: "hablar") : [Word(lang: Lang.en, neutralWord: "speak"), Word(lang: Lang.de, neutralWord: "sprechen")],
          OriginalWord(lang: Lang.es , wordInText: "entonces", neutralWord: "entonces") : [Word(lang: Lang.en, neutralWord: "then / so"), Word(lang: Lang.de, neutralWord: "dann / darauf ")],
          OriginalWord(lang: Lang.es , wordInText: "una familia", neutralWord: "una familia") : [Word(lang: Lang.en, neutralWord: "a family"), Word(lang: Lang.de, neutralWord: "eine Familie ")],
