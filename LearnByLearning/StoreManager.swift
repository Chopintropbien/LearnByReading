...
class StoreManager: NSObject {
    ...
    let purchasableProductsIds:Set<String> = ["lauriane.molllier.learnByReading.russian.1month", "lauriane.molllier.learnByReading.russian.3month", "lauriane.molllier.learnByReading.russian.6month", "lauriane.molllier.learnByReading.russian.12month"]
    
    
    
    //We cloud have an array for every product type so we can check later
    let consumablesProductsIds:Set<String> = []
    ...
    let autoSubscriptionsIds:Set<String> = ["lauriane.molllier.learnByReading.russian.1month", "lauriane.molllier.learnByReading.russian.3month", "lauriane.molllier.learnByReading.russian.6month", "lauriane.molllier.learnByReading.russian.12month"]
    ...
    func requestProducts(ids:Set<String>){
        ...
        if SKPaymentQueue.canMakePayments(){
            ...
            // TODO
            let alert = UIAlertController(title: "Can not make payment title", message: "Can not make payment body", preferredStyle: UIAlertControllerStyle.alert)
